...
export class MeiliPlaylistService {
    ...
    constructor(
        ...
        this.index().updateSearchableAttributes(["name", "slug", "author.name"])
    }
     ...
     */
    public async searchPlaylists(query: string, pageable: Pageable): Promise<SearchResponse<MeiliPlaylist>> {
